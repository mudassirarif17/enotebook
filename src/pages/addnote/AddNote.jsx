...
const AddNote = () => {
  ...
  const { title, description, tag, setTitle, setDescription, setTag, addNote } = context;
    ...
    <div className='flex flex-col md:flex-row'>
      ...
      <div className='w-full'>
        <div className='flex flex-col items-center'>
          ...
          <textarea value={description} onChange={(e) => setDescription(e.target.value)} className='w-[80%] my-3 p-2 rounded-lg border-2 border-gray-300' name="" id="" cols="30" rows="7" placeholder='Decription'></textarea>
