    ...
    <div className='flex flex-col md:flex-row'>
      ...
      <div className='w-full'>
        <div className='flex flex-col items-center'>
          ...
          <input value={alarm} onChange={(e) => setAlarm(e.target.value)} className='w-[80%] my-2 p-2 rounded-lg border-2 border-gray-300' type="time" name="alarm" id="" placeholder='Alarm' />
